...
const ScreenshotButton = ({ screenshot, onScreenshotTake }: ScreenshotButtonProps) => {
  ...
  if(screenshot) {
    return (
      ...
      className="p-1 w-10 h-10 rounded-md border-transparent flex justify-end items-end text-zinc-400 hover:text-zinc-100 transition-colors focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
